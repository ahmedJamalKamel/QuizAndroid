package com.abasathalak.mcqsapp;

public class Constant {

    private static String DOMAIN_URL = "https://mcqs.abasathalak.com/"; //domain or admin panel url
    public static String QUIZ_URL = DOMAIN_URL + "api-v2.php";  //api url
    /////// PARAMETERS  ///////
    public static String AUTHORIZATION = "Authorization";
    public static String JWT_KEY = "20Online%207.0.4";
    ...
    public static int CIRCULAR_MAX_PROGRESS = 25000; // max here we set 25 second for each question, you can increase or decrease time here
    ...
    public static int PASSING_PER = 60;  //count level complete when user give >60 percent correct answer
    public static int giveOneCoin = 1;  //give  coin when user give 60 to 70 percent correct answer
    public static int giveTwoCoins = 2; //give  coins when user give 80 to 90 percent correct answer
    public static int giveThreeCoins = 3; //give  coin when user give 85 to 95 percent correct answer
    public static int giveFourCoins = 4;  //give  coin when user give > 100  percent correct answer

    public static String APP_LINK = "http://play.google.com/store/apps/details?id=com.abasathalak.mcqsapp";
    public static String MORE_APP_URL = "https://play.google.com/store/apps/developer?id=ابسطهالك";
